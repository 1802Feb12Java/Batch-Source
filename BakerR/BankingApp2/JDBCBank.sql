...
CREATE OR REPLACE PROCEDURE REGISTER_USER
    (U_ID OUT NUMBER, UNAME IN VARCHAR2, UTYPE IN NUMBER, FNAME IN VARCHAR2, LNAME IN VARCHAR2, PWHASH IN VARCHAR2)
IS
    TMP_ID NUMBER;
BEGIN
    TMP_ID := PK_USERS.NEXTVAL;
    INSERT INTO USERS VALUES (TMP_ID, UNAME, UTYPE, FNAME, LNAME, PWHASH);
    U_ID := TMP_ID;
    COMMIT;
END;
/
...
IS
    TMP_ID NUMBER;
BEGIN
    TMP_ID := PK_ACCOUNTS.NEXTVAL;
    INSERT INTO ACCOUNTS VALUES (TMP_ID, 1, OWNERID, 0);
    ACCTID := TMP_ID;
    COMMIT;
END;
/
