	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(sessionUser != null){
			...
			if(bankAccount !=null){
				...
				//Jackson API - converts Java Objects to JSON Objects and vice-versa
				//These are from the jars we added in the lib folder 
			...
			response.setStatus(418); //418 is a I'm a teapot
		}
	}
