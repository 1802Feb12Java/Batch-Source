...
public class Basics {
	...
	public static void main(String[] args) {
		 ...
		 * Ex) FirstSecondThird Fields and Methods - Camel Case: Ex) firstSecondThird
		 * Packages - lower case seperated by periods Ex) first.second.third Constants -
		 * All Caps deliminated by underscores Ex) FIRST.SECOND.THIRD
		 */
