...
public class CustomerDAO {
	...
	public String getUsername(int userId) {
		...
		try {
			...
			System.out.println("Error getting username from CustomerDAO");
			logger.error("Error getting username from CustomerDAO");
	...
	public String getFirstName(int userId) {
		...
		try {
			...
			System.out.println("Error getting first name from CustomerDAO");
			logger.error("Error getting first name from CustomerDAO");
			logger.error(e.toString());
	...
	public String getLastName(int userId) {
		...
		try {
			...
			System.out.println("Error getting last name from CustomerDAO");
			logger.error("Error getting last name from CustomerDAO");
			logger.error(e.toString());
