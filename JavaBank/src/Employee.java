    ...
    private void view()
    {
        ...
        while(!zero)
        {
            ...
            else
            {
                ...
                for ( String username : account_database.get(accountID).account_holders.keySet())
                    System.out.println(username);
                System.out.println("$"+account_database.get(accountID).moneyz);
                System.out.println("Likes walks on the beach");
            }
