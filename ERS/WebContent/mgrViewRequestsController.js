...
function getPendingRequests() {
    ...
    req.open("GET", "http://localhost:8080/ERS/ManagerRequestViewServlet?viewType='PENDING'&employeeName=NONE", true);
    req.send(null);
...
function getAllRequests() {
    ...
    var req = new XMLHttpRequest();
    req.open("GET", "http://localhost:8080/ERS/ManagerRequestViewServlet?viewType='ALL'&employeeName=NONE", true);
    req.send(null);
    req.addEventListener("load", function () {
        var tableBody = document.getElementById("mgrRequestViewTableBody");
        tableBody.innerHTML = "";
...
function getApprovedRequests() {
    ...
    var req = new XMLHttpRequest();
    req.open("GET", "http://localhost:8080/ERS/ManagerRequestViewServlet?viewType='APPROVED'&employeeName=NONE", true);
    req.send(null);
    req.addEventListener("load", function () {
        var tableBody = document.getElementById("mgrRequestViewTableBody");
        tableBody.innerHTML = "";
...
function fillEmployeeSelectBox() {
    var req = new XMLHttpRequest();
    req.open("GET", "http://localhost:8080/ERS/EmployeeNameServlet", true);
    req.send(null);

    req.addEventListener("load", function () {
        var dropdownControl = document.getElementById("empSelect");
        if (req.status >= 200 && req.status < 300) {
            ...
            for (var i = 0; i < results.length; i++) {
                ...
                optionItem.value = resultObject.userName;
                optionItem.textContent = resultObject.userName;
