...
public class Q2 {
	private static int numFibs = 0; //keep track of how many times the fibonnacci sequence was done
	...
	public static void fibonacci(int first, int second, int repeats) {
