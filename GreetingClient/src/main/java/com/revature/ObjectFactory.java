...
public class ObjectFactory {
    ...
    private final static QName _GetMessage_QNAME = new QName("http://revature.com/", "getMessage");
    private final static QName _GetMessageResponse_QNAME = new QName("http://revature.com/", "getMessageResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://revature.com/", name = "getMessage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://revature.com/", name = "getMessageResponse")
