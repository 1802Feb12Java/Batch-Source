 ...
 * 2018-04-03T04:27:36.083-04:00
 * Generated source version: 3.1.6
 * 
 */
@WebServiceClient(name = "messageGenService", 
                  wsdlLocation = "http://localhost:8080/SOAPGreeting/greetingservice?wsdl",
                  targetNamespace = "http://revature.com/") 
public class MessageGenService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://revature.com/", "messageGenService");
    public final static QName MessageGenImplPort = new QName("http://revature.com/", "MessageGenImplPort");
    static {
        URL url = null;
        try {
