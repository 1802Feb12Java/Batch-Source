...
;
			while(rs.next()) {
				...
				double bal = rs.getDouble("ACCOUNTBAL");
				System.out.println("userID= " + uid + ", accountID= " + aid + ", username= " + un + ""
						+ ", password= " + pw + ", accountBal= " + bal);
			}
	...
	public void createUser(String name, String password, double bal) throws SQLException {
		Connection connection = null;
	...
	public void giveMoney(User u, double d) throws SQLException {
		Connection connection = null;
	...
	public void takeMoney(User u, double d) throws SQLException {
		Connection connection = null;
		CallableStatement cs = null;
