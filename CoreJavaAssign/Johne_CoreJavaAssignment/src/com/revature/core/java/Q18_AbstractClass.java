 ...
 */
public abstract class Q18_AbstractClass {
	
	public abstract boolean checkUpperCase(String st);
	public abstract String convertToUpper(String st);
	public abstract int addToString(String st);
}
