...
abstract public class AssignmentEighteen {
	/**
	 ...
	 * 
	 */
	abstract boolean containsUppercase(String in);

	abstract String convertToUpper(String in);

	abstract void addTen(String num);
