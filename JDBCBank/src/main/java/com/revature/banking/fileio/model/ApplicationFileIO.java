...
public class ApplicationFileIO implements Serializable {
	...
	public ApplicationFileIO(int ID, int  primaryCustomer) {
		this(ID, primaryCustomer,0);
	}
	public ApplicationFileIO(int Id, int primaryCustomer, int  secondaryCustomer) {
