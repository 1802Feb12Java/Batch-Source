...
public class AccountFileIO implements Serializable{
	private static final long serialVersionUID = 99L;
	private final int accountId;
	private double balance;
	private String status;
	private int primaryCustomerId, secondaryCustomerId;
	public AccountFileIO(int accountId, int primaryCustomerId, String status) {
		this(accountId, primaryCustomerId, 0, status);
	}	
	public AccountFileIO(int accountId, int primaryCustomerId, int secondaryCustomerId, String status) {
		super();
	...
	public void cancel(AdminFileIO admin) {
